...
public class Task<TResult> {
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    conemu.util.tasks.TaskCompletionSource<TResult> tcs = new conemu.util.tasks.TaskCompletionSource<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
    ...
    final conemu.util.tasks.TaskCompletionSource<Void> tcs = new conemu.util.tasks.TaskCompletionSource<>();
  ...
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
    ...
    final conemu.util.tasks.TaskCompletionSource<TResult> tcs = new conemu.util.tasks.TaskCompletionSource<>();
    try {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final conemu.util.tasks.TaskCompletionSource<Task<TResult>> firstCompleted = new conemu.util.tasks.TaskCompletionSource<>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final conemu.util.tasks.TaskCompletionSource<Task<?>> firstCompleted = new conemu.util.tasks.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final conemu.util.tasks.TaskCompletionSource<Void> allFinished = new conemu.util.tasks.TaskCompletionSource<>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final conemu.util.tasks.TaskCompletionSource<TContinuationResult> tcs = new conemu.util.tasks.TaskCompletionSource<>();
    synchronized (lock) {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(
      final conemu.util.tasks.TaskCompletionSource<TContinuationResult> tcs,
  ...
  public class TaskCompletionSource extends conemu.util.tasks.TaskCompletionSource<TResult> {
