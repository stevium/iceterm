 ...
 */
package org.iceterm.cehook.example;

// Imports.

import org.iceterm.cehook.GlobalScreen;
import org.iceterm.cehook.NativeHookException;
 ...
 */
public class NativeHookDemo extends JFrame implements ActionListener, ItemListener, NativeKeyListener, WindowListener {
	...
	public NativeHookDemo() {
		...
		JMenuItem menuItemPost = new JMenuItem("Post Event", KeyEvent.VK_P);
		menuItemPost.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				GlobalScreen.postNativeEvent(new NativeInputEvent(GlobalScreen.class, 64, 0));
			}
		});
		menuItemPost.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F4, ActionEvent.ALT_MASK));
		menuItemPost.getAccessibleContext().setAccessibleDescription("Exit the program");
		menuFile.add(menuItemPost);
	...
	/**
	 * @see org.iceterm.cehook.keyboard.NativeKeyListener#nativeKeyPressed(org.iceterm.cehook.keyboard.NativeKeyEvent)
	 */
	...
	/**
	 * @see org.iceterm.cehook.keyboard.NativeKeyListener#nativeKeyReleased(org.iceterm.cehook.keyboard.NativeKeyEvent)
	 */
	...
	/**
	 * @see org.iceterm.cehook.keyboard.NativeKeyListener#nativeKeyTyped(org.iceterm.cehook.keyboard.NativeKeyEvent)
	 */
