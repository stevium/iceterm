 ...
 */
package org.iceterm.util.tasks;
...
public class Task<TResult> {
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    org.iceterm.util.tasks.TaskCompletionSource<TResult> tcs = new org.iceterm.util.tasks.TaskCompletionSource<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
    ...
    final org.iceterm.util.tasks.TaskCompletionSource<Void> tcs = new org.iceterm.util.tasks.TaskCompletionSource<>();
  ...
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
    ...
    final org.iceterm.util.tasks.TaskCompletionSource<TResult> tcs = new org.iceterm.util.tasks.TaskCompletionSource<>();
    try {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final org.iceterm.util.tasks.TaskCompletionSource<Task<TResult>> firstCompleted = new org.iceterm.util.tasks.TaskCompletionSource<>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final org.iceterm.util.tasks.TaskCompletionSource<Task<?>> firstCompleted = new org.iceterm.util.tasks.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final org.iceterm.util.tasks.TaskCompletionSource<Void> allFinished = new org.iceterm.util.tasks.TaskCompletionSource<>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final org.iceterm.util.tasks.TaskCompletionSource<TContinuationResult> tcs = new org.iceterm.util.tasks.TaskCompletionSource<>();
    synchronized (lock) {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(
      final org.iceterm.util.tasks.TaskCompletionSource<TContinuationResult> tcs,
  ...
  public class TaskCompletionSource extends org.iceterm.util.tasks.TaskCompletionSource<TResult> {
