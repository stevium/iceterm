...
public interface User32Ext extends User32 {
     ...
     */
    boolean GetIconInfo(HICON icon, WinGDI.ICONINFO iconInfo);
     ...
     */
    HANDLE LoadImage(HINSTANCE hinst, Pointer name, int type, int xDesired, int yDesired, int load);
     ...
     */
    int GetClassLong(HWND window, int nIndex);
}
