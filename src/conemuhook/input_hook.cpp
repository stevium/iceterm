...
#include "logger.h"
#include <string>
#include "conemupipe/pipe_client.h"
...
//            MessageBox(0, "EVENT_HOOK_ENABLED", "MessageBox caption", MB_OK);
        ...
        case EVENT_KEY_PRESSED:
            pClient->SetData("EVENT_KEY_PRESSED");
...
//           MessageBox(0, "EVENT_KEY_RELEASED", "MessageBox caption", MB_OK);
        ...
        case EVENT_KEY_TYPED:
            pClient->SetData("EVENT_KEY_TYPED " + std::to_string((char)event->data.keyboard.keychar));
            pClient->SetEvent(AU_IOWRITE);
...
static void process_key_pressed(int nCode, WPARAM wParam, LPARAM lParam) {
    // Check and setup modifiers.
    if (wParam == VK_LSHIFT) { set_modifier_mask(MASK_SHIFT_L); }
    else if (wParam == VK_RSHIFT) { set_modifier_mask(MASK_SHIFT_R); }
    else if (wParam == VK_LCONTROL) { set_modifier_mask(MASK_CTRL_L); }
    else if (wParam == VK_RCONTROL) { set_modifier_mask(MASK_CTRL_R); }
    else if (wParam == VK_LMENU) { set_modifier_mask(MASK_ALT_L); }
    else if (wParam == VK_RMENU) { set_modifier_mask(MASK_ALT_R); }
    else if (wParam == VK_LWIN) { set_modifier_mask(MASK_META_L); }
    else if (wParam == VK_RWIN) { set_modifier_mask(MASK_META_R); }
    else if (wParam == VK_NUMLOCK) { set_modifier_mask(MASK_NUM_LOCK); }
    else if (wParam == VK_CAPITAL) { set_modifier_mask(MASK_CAPS_LOCK); }
    else if (wParam == VK_SCROLL) { set_modifier_mask(MASK_SCROLL_LOCK); }
...
static void process_key_released(int nCode, WPARAM wParam, LPARAM lParam) {
    // Check and setup modifiers.
    if (wParam == VK_LSHIFT) { unset_modifier_mask(MASK_SHIFT_L); }
    else if (wParam == VK_RSHIFT) { unset_modifier_mask(MASK_SHIFT_R); }
    else if (wParam == VK_LCONTROL) { unset_modifier_mask(MASK_CTRL_L); }
    else if (wParam == VK_RCONTROL) { unset_modifier_mask(MASK_CTRL_R); }
    else if (wParam == VK_LMENU) { unset_modifier_mask(MASK_ALT_L); }
    else if (wParam == VK_RMENU) { unset_modifier_mask(MASK_ALT_R); }
    else if (wParam == VK_LWIN) { unset_modifier_mask(MASK_META_L); }
    else if (wParam == VK_RWIN) { unset_modifier_mask(MASK_META_R); }
    else if (wParam == VK_NUMLOCK) { unset_modifier_mask(MASK_NUM_LOCK); }
    else if (wParam == VK_CAPITAL) { unset_modifier_mask(MASK_CAPS_LOCK); }
    else if (wParam == VK_SCROLL) { unset_modifier_mask(MASK_SCROLL_LOCK); }
